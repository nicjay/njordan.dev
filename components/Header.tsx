...
function NavItem({ href, text }: { href: string; text: string }) {
  ...
  return (
    <Link
      href={href}
      className={`text-md rounded-lg px-4 py-2 decoration-purple-700 decoration-1 underline-offset-8 hover:bg-slate-200 dark:decoration-orange-400 hover:dark:bg-slate-800 ${
        isActive
          ? 'font-semibold text-slate-900 underline  dark:text-slate-50'
  ...
  return (
    <div className="flex justify-between">
      <Link href="/" className="flex items-center gap-3">
        ...
        <div className="text-lg font-semibold text-slate-900 dark:text-slate-50">Next.js User</div>
      </Link>
