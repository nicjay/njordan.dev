...
export default function Header() {
  return (
    <div className="flex items-center justify-between">
      ...
      <nav>
        <Link href="/posts">
          <a className="p-4 text-lg text-gray-600 transition hover:text-gray-400 dark:text-gray-400 hover:dark:text-gray-600">
            Posts
          </a>
        </Link>
        <Link href="/stats">
        ...
        <Link href="/about">
          <a className="p-4 pr-6 text-lg text-gray-600 transition hover:text-gray-400 dark:text-gray-400 hover:dark:text-gray-600">
            About
          </a>
        </Link>
        <ThemeSwitch />
